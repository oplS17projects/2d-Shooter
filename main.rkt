...
(define (LETSGO)
  (big-bang
            (make-world (make-player 20 500 3 'alive 'right 0 0)
                        (make-monsters (list (make-monster 1000 100 'alive 'up)
                                             (make-monster 900 200 'alive 'down)
                                             (make-monster 500 500'alive 'right)
                                             (make-monster 800 500 'alive 'left)
                                             (make-monster 350 450 'alive 'left)
                                             (make-monster 700 400 'alive 'up)
                                             (make-monster 600 500 'alive 'down)
                                             (make-monster 100 100 'alive 'up)
                                             (make-monster 175 200 'alive 'up)
                                             (make-monster 500 500'alive 'up)
                                             (make-monster 1200 400 'alive 'down)
                                             (make-monster 1200 500 'alive 'left)
